    ...
    <div className='relative border rounded-md'>
        <div className='flex items-center space-x-10 p-5 bg-gray-100 text-sm text-gray-600'>
            ...
            <div>
                ...
                <p><NumericFormat value={amount} displayType={'text'} thousandSeparator={true} prefix={'$'} />- Next Day Delivery {"    "}
                <NumericFormat value={amountShipping} displayType={'text'} thousandSeparator={true} prefix={'$'} />
                </p>
            </div>
        ...
        <div className='p-5 sm:p-10'>
            <div className='flex space-x-6 overflow-x-auto'>
                {images.map(image => (
                    <img src={image} alt="prodImage" className='h-20 sm:h-32 object-contain'/>
                ))}
            </div>
        </div>
    </div>
